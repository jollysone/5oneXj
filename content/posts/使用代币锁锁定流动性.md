---
title: "使用代币锁锁定流动性"
slug: solidity-token-locker
date: 2022-11-05T11:12:14+08:00
draft: false
author: "5oneXj"
...
### 1. 部署一个标准的`ERC20`合约，并给自己铸造`10000`枚代币。

### 2. 部署`ToeknLocker`合约，代币地址为`ERC20`合约地址，受益人为自己，锁仓期填`180`秒。

![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303052257054.png)

### 3. 将`10000`枚代币转入合约。

![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303052257929.png)

### 4. 在锁仓期`180`秒内调用`release()`函数，无法取出代币。

![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303052258963.png)

### 5. 在锁仓期后调用`release()`函数，成功取出代币。

![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303052258116.png)

## 总结

项目方一般在`DEX`上提供流动性，供投资者交易。项目方突然撤出`LP`会造成`rug-pull`，而将`LP`锁在代币锁合约中可以避免这种情况。
