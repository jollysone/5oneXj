---
title: "合约接收ETH（receive和fallback）"
slug: solidity-receive-eth
date: 2021-07-19T11:12:14+08:00
draft: false
author: "5oneXj"

categories: ["基础知识", "Solidity 进阶"]
tags: ["solidity", "basic", "receive", "fallback"]
---
...
## 总结
`receive()`和`fallback()`，他们主要在两种情况下被使用，他们主要用于处理接收`ETH`和代理合约`proxy contract`。
