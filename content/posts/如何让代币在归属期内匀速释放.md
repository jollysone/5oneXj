---
title: "如何让代币在归属期内匀速释放"
slug: solidity-vesting-wallet
date: 2022-11-27T11:12:14+08:00
draft: false
author: "5oneXj"
...
代码由`OpenZeppelin`的[VestingWallet合约](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/finance/VestingWallet.sol)简化而来。
...
### 1. 先部署一个`ERC20`合约，并给自己铸造`10000`枚代币。

### 2. 部署`TokenVesting`线性释放合约，受益人设为自己，归属期设为`100`秒。

![部署TokenVesting](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303050013476.png)

### 3. 将`10000`枚`ERC20`代币转给线性释放合约。

![转移代币](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303050014905.png)

### 4. 调用`release()`函数提取代币。

![提取代币](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303050014316.png)

## 总结

代币短期大量解锁会对币价造成巨大压力，而约定代币归属条款可以缓解抛压，并防止团队和资本方过早躺平。
