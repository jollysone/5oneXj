---
title: "合约安全：整型溢出"
slug: solidity-smart-contract-security-overflow
date: 2022-08-25T11:12:14+08:00
draft: false
author: "5oneXj"

categories: ["合约安全"]
tags: ["solidity", "security", "Safemath"]
---

{{< admonition quote "引言" >}}
整型溢出漏洞（Arithmetic Over/Under Flows）是一个比较经典的漏洞，Solidity 0.8 版本后内置了Safemath库，因此很少发生。
{{< /admonition >}}
...
介绍了经典的整型溢出漏洞，由于solidity 0.8.0 版本后内置 `Safemath` 的整型溢出检查，这类漏洞已经很少见了。