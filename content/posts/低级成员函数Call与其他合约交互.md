---
title: "低级成员函数Call与其他合约交互"
slug: solidity-call
date: 2021-08-13T11:12:14+08:00
draft: false
author: "5oneXj"
...
其中`二进制编码`利用结构化编码函数`abi.encodeWithSignature`获得，abi.encodeWithSignature("函数签名", 逗号分隔的具体参数)，`函数签名`为`"函数名（逗号分隔的参数类型)"`。：
...
![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303022253865.png)
...
![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303022253544.png)
...
![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202303022254064.png)

## 总结

`call`不是调用合约的推荐方法，**因为不安全**。但他能让我们在不知道源代码和`ABI`的情况下调用目标合约，很有用。