---
title: "合约安全：签名重放"
slug: solidity-smart-contract-security-signature-replay
date: 2022-09-19T11:12:14+08:00
draft: false
author: "5oneXj"

categories: ["合约安全"]
tags: ["solidity", "security", "signature"]
---

{{< admonition quote "引言" >}}
智能合约的签名重放（Signature Replay）攻击和预防方法，它曾间接导致了著名做市商 Wintermute 被盗2000万枚 $OP。
{{< /admonition >}}
...
![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202302252243693.png)

**2.** 利用`getMessageHash`函数获取消息。

![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202302252243626.png)

**3.** 点击 `Remix` 部署面板的签名按钮，使用私钥给消息签名。

![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202302252243425.png)

**4.** 反复调用 `badMint` 进行签名重放攻击，铸造大量代币。

![](https://raw.githubusercontent.com/jollysone/Picture-Library/master/blog/202302252244039.png)
